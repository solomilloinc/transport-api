...
namespace transport.infraestructure.Migrations
{
    ...
    [Migration("20260420231227_AddTenantReserveConfig")]
    partial class AddTenantReserveConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Transport.Domain.Tenants.TenantReserveConfig", b =>
                {
                    b.Property<int>("TenantReserveConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TenantReserveConfigId"));
                    ...
                    b.Property<bool>("RoundTripSameDayOnly")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.HasKey("TenantReserveConfigId");

                    b.HasIndex("TenantId")
                        .IsUnique();

                    b.ToTable("TenantReserveConfig", (string)null);
                });
            ...
            modelBuilder.Entity("Transport.Domain.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2026, 4, 20, 23, 12, 26, 510, DateTimeKind.Utc).AddTicks(4981),
                            Name = "Administrador"
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2026, 4, 20, 23, 12, 26, 510, DateTimeKind.Utc).AddTicks(4982),
                            Name = "Cliente"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2026, 4, 20, 23, 12, 26, 510, DateTimeKind.Utc).AddTicks(4984),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Transport.Domain.Tenants.TenantReserveConfig", b =>
                {
                    b.HasOne("Transport.Domain.Tenants.Tenant", "Tenant")
                        .WithOne("ReserveConfig")
                        .HasForeignKey("Transport.Domain.Tenants.TenantReserveConfig", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
