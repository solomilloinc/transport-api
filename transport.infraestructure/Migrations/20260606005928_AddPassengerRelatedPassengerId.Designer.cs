...
namespace transport.infraestructure.Migrations
{
    ...
    [Migration("20260606005928_AddPassengerRelatedPassengerId")]
    partial class AddPassengerRelatedPassengerId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Transport.Domain.Passengers.Passenger", b =>
                {
                    ...
                    b.Property<int?>("RelatedPassengerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Transport.Domain.Tenants.TenantConfig", b =>
                {
                    ...
                    b.Property<int>("ReserveGenerationDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(15);
            ...
            modelBuilder.Entity("Transport.Domain.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = 1,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2026, 6, 6, 0, 59, 28, 247, DateTimeKind.Utc).AddTicks(4155),
                            Name = "Administrador"
                        },
                        new
                        {
                            RoleId = 2,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2026, 6, 6, 0, 59, 28, 247, DateTimeKind.Utc).AddTicks(4157),
                            Name = "Cliente"
                        },
                        new
                        {
                            RoleId = 3,
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2026, 6, 6, 0, 59, 28, 247, DateTimeKind.Utc).AddTicks(4158),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("Transport.Domain.Passengers.Passenger", b =>
                {
                    ...
                    b.HasOne("Transport.Domain.Passengers.Passenger", "RelatedPassenger")
                        .WithMany()
                        .HasForeignKey("RelatedPassengerId")
                        .OnDelete(DeleteBehavior.NoAction);
